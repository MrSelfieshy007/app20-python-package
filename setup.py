...
setup(
  name = 'invoicing-pdf-harshith',         #* Your package will have this name
  ...
  author = 'Harshith Nadig',                   # Your name
  author_email = 'harshithnadig1@gmail.com',  # Your email
  url = 'https://github.com/MrSelfieshy007',              # Homepage of your library (e.g. github or your website)
